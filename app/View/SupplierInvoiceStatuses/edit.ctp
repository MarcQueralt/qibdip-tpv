...
<?php echo $this->Form->create('SupplierInvoiceStatus'); ?>
	<fieldset>
		<legend><?php echo __('Edit Supplier Invoice Status'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SupplierInvoiceStatus.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SupplierInvoiceStatus.id'))); ?></li>
