...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Stock Supplier Slip Id'); ?></th>
		<th><?php echo __('Stock Supplier Slip Line'); ?></th>
		<th><?php echo __('Stock Supplier Invoice Id'); ?></th>
	...
	<?php
		...
		<tr>
			...
			<td><?php echo $stock['stock_supplier_slip_id']; ?></td>
			<td><?php echo $stock['stock_supplier_slip_line']; ?></td>
			<td><?php echo $stock['stock_supplier_invoice_id']; ?></td>
			<td class="actions">
