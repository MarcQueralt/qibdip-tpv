...
<?php echo $this->Form->create('CustomerOrder'); ?>
	<fieldset>
		<legend><?php echo __('Edit Customer Order'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CustomerOrder.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CustomerOrder.id'))); ?></li>
