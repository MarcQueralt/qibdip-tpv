<div class="customerPayments index">
	<h2><?php echo __('Customer Payments'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $customerPayment['CustomerPayment']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $customerPayment['CustomerPayment']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $customerPayment['CustomerPayment']['id']), null, __('Are you sure you want to delete # %s?', $customerPayment['CustomerPayment']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
